                ...
                <div className={styles.settingPage__items}>
                    <div className={styles.settingPage__items__name}>
                        ...
                        <b onClick={logOut} className={styles.settingPage__items__name__add}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                                <circle cx="12" cy="12" r="10" fill="#fff" stroke="red"></circle>
                                <path d="M12 8v8" stroke="red"></path>
                            </svg>
